//
//  PreferLooksSettingViewController.swift
//  Percent
//
...
class PreferLooksSettingViewController: BaseViewController {
    ...
    override init(navigationViewEffect effect: UIVisualEffect? = nil) {
        ...
        if let timeInterval = QDataManager.shared.preferSettingDate {
            let latestDate = Date(timeIntervalSince1970: timeInterval)
            
            let formatter = DateFormatter()
            formatter.dateFormat = "yyyyMMdd"
            
            let latestDateStr = formatter.string(from: latestDate)
    ...
    override func viewDidLoad() {
        ...
        imageViewLooks.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor).isActive = true
    ...
    private func reloadEvaluatingData() {
        QDataManager.shared.preferSettingCount = currentPage
        QDataManager.shared.commit()
    ...
    private func showNoData() {
        let viewController = PreferLooksNoDataViewController()
        viewController.view.translatesAutoresizingMaskIntoConstraints = false
        self.addChild(viewController)
        self.view.addSubview(viewController.view)
        
        viewController.view.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor).isActive = true
        viewController.view.leadingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.leadingAnchor).isActive = true
        viewController.view.trailingAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.trailingAnchor).isActive = true
        viewController.view.bottomAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.bottomAnchor).isActive = true
    }
}

extension PreferLooksSettingViewController: UICollectionViewDelegate, UICollectionViewDataSource {
