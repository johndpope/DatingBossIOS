//
//  BaseEditProfileViewController.swift
//  Percent
//
...
class BaseEditProfileViewController: BaseSignupStepsViewController {
    internal let theScrollView = UIScrollView()
    
    internal let collectionViewPictures: UICollectionView!
    internal var replaceIndex: Int?
    
    internal let entryViewHeight = SignupProfilePopupEntryView()
    internal let entryViewShape = SignupProfilePopupEntryView()
    internal let entryViewBlood = SignupProfilePopupEntryView()
    internal let entryViewRegion = SignupProfilePopupEntryView()
    internal let entryViewEducation = SignupProfilePopupEntryView()
    internal let entryViewEducationDetail = SignupProfileTextEntryView()
    internal let entryViewJob = SignupProfilePopupEntryView()
    internal let entryViewJobDetail = SignupProfileTextEntryView()
    internal let entryViewWage = SignupProfilePopupEntryView()
    internal let entryViewReligion = SignupProfilePopupEntryView()
    internal let entryViewHobby = SignupProfilePopupEntryView()
    internal let entryViewDrinking = SignupProfilePopupEntryView()
    internal let entryViewSmoking = SignupProfilePopupEntryView()
    
    internal var seperatorJobDetail: UIView!
    
    internal let buttonTextView = UIButton(type: .custom)
    internal let textViewComment = UITextView()
    internal var constraintTextViewHeight: NSLayoutConstraint!
    
    internal let buttonCancel = UIButton(type: .custom)
    internal let buttonConfirm = UIButton(type: .custom)
    
    internal var pickerData = [Any]()
    
    internal var selectedEntryView: SignupProfileEntryView?
    internal var editingView: UIView?
    
    internal var selectedDataArray = [String]()
    
    internal weak var activatingEntryView: SignupProfileEntryView?
    
    internal var constraintJobDetailHeight: NSLayoutConstraint!
    
    internal weak var textfieldSearch: UITextField?
    internal var searchResults = [AppData]()
    internal weak var showingTableView: UITableView?
    ...
    internal func uploadProfile(_ completion: ((Bool) -> Void)? = nil) {
...
extension BaseEditProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension BaseEditProfileViewController: UIPopoverPresentationControllerDelegate {
    func popoverPresentationControllerDidDismissPopover(_ popoverPresentationController: UIPopoverPresentationController) {
        self.view.alpha = 1.0
    }
}

extension BaseEditProfileViewController: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
extension BaseEditProfileViewController: UIScrollViewDelegate {
...
extension BaseEditProfileViewController: UITextViewDelegate {
...
extension BaseEditProfileViewController: UITextFieldDelegate {
...
extension BaseEditProfileViewController: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension BaseEditProfileViewController: UITableViewDelegate, UITableViewDataSource {
...
extension BaseEditProfileViewController: BasePopupViewControllerDelegate {
